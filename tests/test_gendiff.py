...
def test_flat_files_json():
    assert result_json == generate_diff('./tests/fixtures/test_before.json',
                                   './tests/fixtures/test_after.json',"json")
    assert result_json == generate_diff('./tests/fixtures/test_before.yml',
                                   './tests/fixtures/test_after.yml',"json")


def test_nested_files_json():
    assert result_nested_json == generate_diff('./tests/fixtures/test_before_nested.json',
                                          './tests/fixtures/test_after_nested.json',
                                          "json")
    assert result_nested_json == generate_diff('./tests/fixtures/test_before_nested.yaml',
                                          './tests/fixtures/test_after_nested.yml',
                                          "json")
